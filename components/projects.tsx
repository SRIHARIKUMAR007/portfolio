...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Developed a classification system to predict diabetes using six data mining algorithms. Applied data preprocessing techniques, performance metric comparison, and feature importance extraction. Achieved highest accuracy with Random Forest Classifier.",
      image:
    ...
    },
    {
      title: "Pong Game",
      description:
        "Developed a classic Pong game in Java, incorporating AI logic using conditional statements to calculate ball movement, detect collisions, and determine the game winner. The AI opponent adapts its paddle movement based on the ball's position.",
      image: "/images/pong-game.png",
      technologies: ["Java", "JDK", "AI Logic"],
